...
export default function Index() {
    ...
    }, [params.filter, params.query, params.advancedFilter]); // Added advancedFilter to dependencies
            ...
            <FlatList
                ...
                ListHeaderComponent={
                    <View className="px-5">
                        <View className="flex flex-row items-center justify-between mt-5">
                            <View className="flex flex-row items center">
                                ...
                                <View className="flex flex-col items-start ml-2 justify-center">
                                    <Text className="text-xs font0rubik text-black-100">Privet</Text>
                        ...
                        <View className="flex flex-row items-center justify-between">
                            <Text className="text-xl font-rubik-bold text-black-300">Our Nice Deals</Text>
                            <TouchableOpacity onPress={() => router.push("/(root)/(tabs)/explore")}>
                                <Text className="text-base font-rubik-bold text-primary-300">See all</Text>
                            </TouchableOpacity>
                        </View>
